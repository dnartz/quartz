...
var quartzConfig, quartzService;

angular.module('quartz', ['quartz.services', 'quartz.config', 'quartz.theme', 'ngSanitize']).config([
...
quartzService = angular.module('quartz.services', ['ngResource', 'ngRoute']).service('titleFn', [
