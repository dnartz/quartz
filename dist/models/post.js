...
var arrayIndex2PostId, categories, categoriesIndex, category, cutContent, fetchPropertiesById, idsAndPropretiesCheck, idsCheck, isEmptyArray, post, postFileds, postIds, posts, postsIdIndex, propertiesCheck, tagsIndex, tagsList, that, _, _i, _j, _len, _len1,
  __slice = [].slice;
...
propertiesCheck = function(properties) {
  ...
  if (_.intersection(properties, postFileds).length === 0) {
    return false;
  } else {
    return properties;
  }
...
idsAndPropretiesCheck = function(fn) {
  return function() {
    var args, ids;
...
module.exports = {
   ...
   */
  getPropertiesById: idsAndPropretiesCheck(function(ids, properties, moreTag) {
    if (moreTag == null) {
      moreTag = false;
    }
