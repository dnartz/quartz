...
var commentFields, comments, idsCheck, maxCommentId, md5, minCommentInterval, postComments, postsIdIndex, validator, writeFile, xssClean, _,
...
maxCommentId = require(__dirname + '/../dao/comment').maxCommentId;

commentFields = require(__dirname + '/../data/config/config').commentFields;

minCommentInterval = require(__dirname + '/../data/config/config').minCommentInterval;
